...
{
    public class RoomsApiCrudUserStore : IUserStore<RoomsApiCrudUser>, IUserEmailStore<RoomsApiCrudUser>, IUserPhoneNumberStore<RoomsApiCrudUser>,
        IUserTwoFactorStore<RoomsApiCrudUser>, IUserPasswordStore<RoomsApiCrudUser>, IUserRoleStore<RoomsApiCrudUser>
    {
        private readonly string _connectionString;

        public RoomsApiCrudUserStore(IConfiguration configuration)
        {
